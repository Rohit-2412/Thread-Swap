    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      >
        <Toolbar>
          ...
          >
            <Button
              className={currentButton === "home" ? "current" : ""}
              color="inherit"
          ...
          >
            <Button
              className={currentButton === "aboutUs" ? "current" : ""}
              color="inherit"
              sx={{ color: "white", fontWeight: "bold", mx: 2 }}
          ...
          >
            <Button
              className={currentButton === "shop" ? "current" : ""}
              color="inherit"
              sx={{ color: "white", fontWeight: "bold", mx: 2 }}
          ...
          >
            <Button
              className={currentButton === "sell" ? "current" : ""}
              color="inherit"
              sx={{ color: "white", fontWeight: "bold", mx: 2 }}
          ...
          >
            <Button
              className={currentButton === "contact" ? "current" : ""}
              color="inherit"
              sx={{ color: "white", fontWeight: "bold", mx: 2 }}
          ...
          >
            <Button
              className={currentButton === "signup" ? "current" : ""}
              color="inherit"
              sx={{
                color: "white",
                fontWeight: "bold",
          ...
          >
            <Button
              className={currentButton === "login" ? "current" : ""}
              color="inherit"
              sx={{
                color: "white",
                fontWeight: "bold",
