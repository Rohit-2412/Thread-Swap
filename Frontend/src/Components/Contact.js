        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          >
            <CardActionArea
              ...
              target="_blank"
            >
              <CardMedia component="img" height="160" image={insta} />
              <CardContent>
          ...
          >
            <CardActionArea
              ...
              target="_blank"
            >
              <CardMedia component="img" height="160" image={linkedin} />
              <CardContent>
                <Typography gutterBottom variant="h5" component="div">
                  LinkedIn
                </Typography>
          ...
          >
            <CardActionArea
              ...
              target="_blank"
            >
              <CardMedia component="img" height="160" image={github} />
              <CardContent>
                <Typography gutterBottom variant="h5" component="div">
                  GitHub
                </Typography>
          ...
          >
            <CardActionArea
              ...
              target="_blank"
            >
              <CardMedia component="img" height="160" image={gmail} />
              <CardContent>
                <Typography gutterBottom variant="h5" component="div">
                  Mail Us
                </Typography>
