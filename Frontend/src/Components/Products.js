...
function Products() {
  ...
  useEffect(() => {
    axios
      .get(`${domain}/${categoryMap[category]}/${filteredWords}/products`)
      .then((response) => {
  ...
  const handleColorChange = (color) => {
    setSelectedColors((prevSelectedColors) => {
      ...
      if (prevSelectedColors.includes(color)) {
        newSelectedColors = prevSelectedColors.filter(
  ...
  const handleSizeChange = (size) => {
    setSelectedSizes((prevSelectedSizes) => {
      ...
      if (prevSelectedSizes.includes(size)) {
        newSelectedSizes = prevSelectedSizes.filter(
    ...
    const newFilteredProducts = products.filter(
      (product) =>
        (newSelectedColors.length === 0 ||
          newSelectedColors.includes(product.color)) &&
        (newSelectedSizes.length === 0 ||
          newSelectedSizes.includes(product.size))
    );
          ...
          >
            ...
            >
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    checked={selectedColors.includes("Maroon")}
                    onChange={() => handleColorChange("Maroon")}
                    style={{ color: "Maroon" }}
                  />
                }
                label="Maroon"
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    ...
                    onChange={() => handleColorChange("Navy")}
                    style={{ color: "Navy" }}
                  />
                }
                label="Navy"
